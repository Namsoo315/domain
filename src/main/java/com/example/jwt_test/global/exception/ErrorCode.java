package com.example.jwt_test.global.exception;
...
public enum ErrorCode {
    ...
    TICKETING_NOT_FOUND(HttpStatus.NOT_FOUND, "예매내역이 존재하지 않습니다."),
